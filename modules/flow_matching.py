...
class BASECFM(torch.nn.Module, ABC):
    ...
    def inference(self, mu, x_lens, prompt, style, f0, n_timesteps, temperature=1.0, inference_cfg_rate=0.5, trus_ctx=None):
        """Forward diffusion
        ...
        return self.solve_euler(z, x_lens, prompt, mu, style, f0, t_span, inference_cfg_rate,trus_ctx=trus_ctx)

    def solve_euler(self, x, x_lens, prompt, mu, style, f0, t_span, inference_cfg_rate=0.5,trus_ctx=None):
        """
        ...
        for step in tqdm(range(1, len(t_span))):
            ...
            if inference_cfg_rate > 0:
                ...
                stacked_dphi_dt = self.estimator(
                    stacked_x, stacked_prompt_x, x_lens, stacked_t, stacked_style, stacked_mu,trus_ctx=trus_ctx, step_idx=step
                )
    ...
    trus_ctx=trus_ctx, step_idx=step
)
