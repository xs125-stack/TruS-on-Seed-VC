...
class CFM(torch.nn.Module):
    ...
    def inference(self,
        ...
        return self.solve_euler(z, x_lens, prompt, mu, style, t_span, inference_cfg_rate, random_voice,trus_manager=trus_manager)
    def solve_euler(self, x, x_lens, prompt, mu, style, t_span, inference_cfg_rate=[0.5, 0.5], random_voice=False,trus_manager=None,):
        """
        ...
        for step in tqdm(range(1, len(t_span))):
            if trus_manager is not None:
                trus_manager.set_step(step - 1)
